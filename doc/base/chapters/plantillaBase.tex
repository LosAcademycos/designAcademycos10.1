...
%	\epigraph{\comillas{Algunos misterios siempre escaparán a la mente humana. Para convencernos de ello, sólo hay que echar un vistazo a las tablas de los números primos, y ver que no reina ni orden, ni reglas}}{--- \textup{Évariste Galois}}
	...
	Un gran documento debe tener cualidades desde orden en su código y por supuesto organización en sus carpetas, pensando en ello el paquete DesignEditorial\printversion recomienda la siguiente estructura
	\begin{figure}[H]
		\dirtree{%
			.1 {\color{treeDefault}\faFolder} DesignEditorial\printversion.
	...
	\begin{figure}[H]
		\dirtree{%
			...
			.2 {\color{treeDefault}\faFolder} DesignEditorial\printversion\space (submodulo git).
